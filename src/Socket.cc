...
void Socket::setReuseAddr(bool on)
{
	...
	// 允许在 TIME_WAIT 状态下重新绑定相同的 IP 地址，服务器重启时会进入1-4分钟的time-wait，操作系统不会释放端口，需要等很久才能重新绑定
...
void Socket::setReusePort(bool on)
{
	...
	// 允许多个进程同时监听一个端口，接受多个请求，通常用于服务端接受连接
